...
def model_loadobj(dirname, obj_type, d=None, custom_predictor=None):
    ...
    if obj_type in ("param", "binner"):
        ...
        custom_predictor.load(pred_path, d["predictor_input_shape"],
                                          d["predictor_output_shape"])
